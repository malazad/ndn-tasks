...
#ifndef NDN_PEERCONSUMER_H
#define NDN_PEERCONSUMER_H
...
protected:
  ...
  int m_retxCount;
  bool m_sendSync;
  bool m_pushDataPacket;
  std::string m_DataPacket;
  Name m_peerName;
  bool m_getMetaData;
  uint32_t m_start;
  uint32_t m_end;
  uint32_t m_currentFileNumber;
  uint32_t m_peerKey;
  bool m_isValidPeer;
